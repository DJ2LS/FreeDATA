...
class ScheduleManager:
    ...
    def __init__(self, ctx):
        ...
        self.events = {
            ...
            'pskreporter_publishing': {'function': self.push_to_pskreporter, 'interval': 300},
    ...
    def push_to_pskreporter(self):


        if self.ctx.config_manager.config['STATION']['enable_pskreporter'] and self.ctx.state_manager.is_modem_running:
            try:
                pskreporter.Pskreporter(self.ctx).push()
            except Exception as e:
                print(e)
