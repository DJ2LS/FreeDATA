...
while receive == True:
    ...
    if nbytes == bytes_per_frame:
            ...
            burst = bytes_out[0]
            frame = bytes_out[1]
            print("RX | BURST: " + str(burst) + " FRAME: " + str(frame) + " >>> SENDING PONG")
            
            
            TRANSMIT_PONG = threading.Thread(target=send_pong, args=[burst,frame], name="SEND PONG")
            TRANSMIT_PONG.start()
