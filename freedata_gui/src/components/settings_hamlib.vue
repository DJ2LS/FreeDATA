  ...
  <div :class="settings.remote.RADIO.control == 'rigctld_bundle' ? '' : 'd-none'">
    ...
    <div class="input-group input-group-sm mb-1">
      ...
      >
        ...
        <option value="25013">
          AMSAT-UK FUNcube (25013)
        </option>
        <option value="25018">
          AMSAT-UK FUNcube (25018)
        </option>
        <option value="5008">
          AOR AR2700 (5008)
        </option>
        ...
        <option value="23003">
          DTTS Microwave (23003)
        </option>
        <option value="23004">
          DTTS Microwave (23004)
        </option>
        <option value="33001">
          ELAD FDM-DUO (33001)
        </option>
        ...
        <option value="25001">
          Elektor Elektor (25001)
        </option>
        <option value="25007">
          Elektor Elektor (25007)
        </option>
        <option value="25012">
          FiFi FiFi-SDR (25012)
        </option>
        ...
        <option value="23001">
          Flex-radio SDR-1000 (23001)
        </option>
        <option value="2048">
          FlexRadio/ANAN PowerSDR/Thetis (2048)
        </option>
        <option value="25015">
          Funkamateur FA-SDR (25015)
        </option>
        <option value="35001">
          GOMSPACE GS100 (35001)
        </option>
        <option value="2046">
        ...
        <option value="16007">
          Ten-Tec TT-516 (16007)
        </option>
        <option value="16002">
          Ten-Tec TT-538 (16002)
        </option>
        <option value="16001">
          Ten-Tec TT-550 (16001)
        </option>
        <option value="16008">
          Ten-Tec TT-565 (16008)
        </option>
        <option value="16009">
          Ten-Tec TT-585 (16009)
        </option>
        <option value="16011">
          Ten-Tec TT-588 (16011)
        </option>
        <option value="16013">
          Ten-Tec TT-599 (16013)
        </option>
        <option value="8002">
        ...
        <option value="1033">
          Vertex Standard (1033)
        </option>
        <option value="26001">
          Video4Linux SW/FM (26001)
        </option>
        <option value="26002">
          Video4Linux2 SW/FM (26002)
        </option>
        <option value="12004">
