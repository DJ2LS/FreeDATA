...
class confparams_u_c(object):
    ...
    __repr__ = _swig_repr
    combostr = property(
        _Hamlib.confparams_u_c_combostr_get, _Hamlib.confparams_u_c_combostr_set
    )
...
class freq_range_t(object):
    ...
    low_power = property(
        _Hamlib.freq_range_t_low_power_get, _Hamlib.freq_range_t_low_power_set
    )
    high_power = property(
        _Hamlib.freq_range_t_high_power_get, _Hamlib.freq_range_t_high_power_set
    )
...
class tuning_step_list(object):
    ...
    __repr__ = _swig_repr
    modes = property(
        _Hamlib.tuning_step_list_modes_get, _Hamlib.tuning_step_list_modes_set
    )
...
class channel(object):
    ...
    __repr__ = _swig_repr
    channel_num = property(
        _Hamlib.channel_channel_num_get, _Hamlib.channel_channel_num_set
    )
    ...
    rptr_shift = property(
        _Hamlib.channel_rptr_shift_get, _Hamlib.channel_rptr_shift_set
    )
    rptr_offs = property(_Hamlib.channel_rptr_offs_get, _Hamlib.channel_rptr_offs_set)
    tuning_step = property(
        _Hamlib.channel_tuning_step_get, _Hamlib.channel_tuning_step_set
    )
    ...
    ctcss_tone = property(
        _Hamlib.channel_ctcss_tone_get, _Hamlib.channel_ctcss_tone_set
    )
    ...
    scan_group = property(
        _Hamlib.channel_scan_group_get, _Hamlib.channel_scan_group_set
    )
    flags = property(_Hamlib.channel_flags_get, _Hamlib.channel_flags_set)
    channel_desc = property(
        _Hamlib.channel_channel_desc_get, _Hamlib.channel_channel_desc_set
    )
    ext_levels = property(
        _Hamlib.channel_ext_levels_get, _Hamlib.channel_ext_levels_set
    )
...
class channel_cap(object):
    ...
    __repr__ = _swig_repr
    bank_num = property(
        _Hamlib.channel_cap_bank_num_get, _Hamlib.channel_cap_bank_num_set
    )
    ...
    tx_width = property(
        _Hamlib.channel_cap_tx_width_get, _Hamlib.channel_cap_tx_width_set
    )
    ...
    rptr_shift = property(
        _Hamlib.channel_cap_rptr_shift_get, _Hamlib.channel_cap_rptr_shift_set
    )
    rptr_offs = property(
        _Hamlib.channel_cap_rptr_offs_get, _Hamlib.channel_cap_rptr_offs_set
    )
    tuning_step = property(
        _Hamlib.channel_cap_tuning_step_get, _Hamlib.channel_cap_tuning_step_set
    )
    ...
    ctcss_tone = property(
        _Hamlib.channel_cap_ctcss_tone_get, _Hamlib.channel_cap_ctcss_tone_set
    )
    ctcss_sql = property(
        _Hamlib.channel_cap_ctcss_sql_get, _Hamlib.channel_cap_ctcss_sql_set
    )
    dcs_code = property(
        _Hamlib.channel_cap_dcs_code_get, _Hamlib.channel_cap_dcs_code_set
    )
    dcs_sql = property(_Hamlib.channel_cap_dcs_sql_get, _Hamlib.channel_cap_dcs_sql_set)
    scan_group = property(
        _Hamlib.channel_cap_scan_group_get, _Hamlib.channel_cap_scan_group_set
    )
    flags = property(_Hamlib.channel_cap_flags_get, _Hamlib.channel_cap_flags_set)
    channel_desc = property(
        _Hamlib.channel_cap_channel_desc_get, _Hamlib.channel_cap_channel_desc_set
    )
    ext_levels = property(
        _Hamlib.channel_cap_ext_levels_get, _Hamlib.channel_cap_ext_levels_set
    )
...
class cal_table_float_table(object):
    ...
    __repr__ = _swig_repr
    raw = property(
        _Hamlib.cal_table_float_table_raw_get, _Hamlib.cal_table_float_table_raw_set
    )
    val = property(
        _Hamlib.cal_table_float_table_val_get, _Hamlib.cal_table_float_table_val_set
    )

    def __init__(self):
        _Hamlib.cal_table_float_table_swiginit(
            self, _Hamlib.new_cal_table_float_table()
        )
...
class rig_spectrum_scope(object):
    ...
    name = property(
        _Hamlib.rig_spectrum_scope_name_get, _Hamlib.rig_spectrum_scope_name_set
    )
...
class rig_spectrum_avg_mode(object):
    ...
    __repr__ = _swig_repr
    id = property(
        _Hamlib.rig_spectrum_avg_mode_id_get, _Hamlib.rig_spectrum_avg_mode_id_set
    )
    name = property(
        _Hamlib.rig_spectrum_avg_mode_name_get, _Hamlib.rig_spectrum_avg_mode_name_set
    )

    def __init__(self):
        _Hamlib.rig_spectrum_avg_mode_swiginit(
            self, _Hamlib.new_rig_spectrum_avg_mode()
        )
...
class rig_spectrum_line(object):
    ...
    data_level_min = property(
        _Hamlib.rig_spectrum_line_data_level_min_get,
        _Hamlib.rig_spectrum_line_data_level_min_set,
    )
    data_level_max = property(
        _Hamlib.rig_spectrum_line_data_level_max_get,
        _Hamlib.rig_spectrum_line_data_level_max_set,
    )
    signal_strength_min = property(
        _Hamlib.rig_spectrum_line_signal_strength_min_get,
        _Hamlib.rig_spectrum_line_signal_strength_min_set,
    )
    signal_strength_max = property(
        _Hamlib.rig_spectrum_line_signal_strength_max_get,
        _Hamlib.rig_spectrum_line_signal_strength_max_set,
    )
    spectrum_mode = property(
        _Hamlib.rig_spectrum_line_spectrum_mode_get,
        _Hamlib.rig_spectrum_line_spectrum_mode_set,
    )
    center_freq = property(
        _Hamlib.rig_spectrum_line_center_freq_get,
        _Hamlib.rig_spectrum_line_center_freq_set,
    )
    span_freq = property(
        _Hamlib.rig_spectrum_line_span_freq_get, _Hamlib.rig_spectrum_line_span_freq_set
    )
    low_edge_freq = property(
        _Hamlib.rig_spectrum_line_low_edge_freq_get,
        _Hamlib.rig_spectrum_line_low_edge_freq_set,
    )
    high_edge_freq = property(
        _Hamlib.rig_spectrum_line_high_edge_freq_get,
        _Hamlib.rig_spectrum_line_high_edge_freq_set,
    )
    spectrum_data_length = property(
        _Hamlib.rig_spectrum_line_spectrum_data_length_get,
        _Hamlib.rig_spectrum_line_spectrum_data_length_set,
    )
    spectrum_data = property(
        _Hamlib.rig_spectrum_line_spectrum_data_get,
        _Hamlib.rig_spectrum_line_spectrum_data_set,
    )
...
class rig_caps(object):
    ...
    serial_rate_min = property(
        _Hamlib.rig_caps_serial_rate_min_get, _Hamlib.rig_caps_serial_rate_min_set
    )
    serial_rate_max = property(
        _Hamlib.rig_caps_serial_rate_max_get, _Hamlib.rig_caps_serial_rate_max_set
    )
    serial_data_bits = property(
        _Hamlib.rig_caps_serial_data_bits_get, _Hamlib.rig_caps_serial_data_bits_set
    )
    serial_stop_bits = property(
        _Hamlib.rig_caps_serial_stop_bits_get, _Hamlib.rig_caps_serial_stop_bits_set
    )
    serial_parity = property(
        _Hamlib.rig_caps_serial_parity_get, _Hamlib.rig_caps_serial_parity_set
    )
    serial_handshake = property(
        _Hamlib.rig_caps_serial_handshake_get, _Hamlib.rig_caps_serial_handshake_set
    )
    write_delay = property(
        _Hamlib.rig_caps_write_delay_get, _Hamlib.rig_caps_write_delay_set
    )
    post_write_delay = property(
        _Hamlib.rig_caps_post_write_delay_get, _Hamlib.rig_caps_post_write_delay_set
    )
    ...
    has_get_func = property(
        _Hamlib.rig_caps_has_get_func_get, _Hamlib.rig_caps_has_get_func_set
    )
    has_set_func = property(
        _Hamlib.rig_caps_has_set_func_get, _Hamlib.rig_caps_has_set_func_set
    )
    has_get_level = property(
        _Hamlib.rig_caps_has_get_level_get, _Hamlib.rig_caps_has_get_level_set
    )
    has_set_level = property(
        _Hamlib.rig_caps_has_set_level_get, _Hamlib.rig_caps_has_set_level_set
    )
    has_get_parm = property(
        _Hamlib.rig_caps_has_get_parm_get, _Hamlib.rig_caps_has_get_parm_set
    )
    has_set_parm = property(
        _Hamlib.rig_caps_has_set_parm_get, _Hamlib.rig_caps_has_set_parm_set
    )
    level_gran = property(
        _Hamlib.rig_caps_level_gran_get, _Hamlib.rig_caps_level_gran_set
    )
    ...
    ext_tokens = property(
        _Hamlib.rig_caps_ext_tokens_get, _Hamlib.rig_caps_ext_tokens_set
    )
    ctcss_list = property(
        _Hamlib.rig_caps_ctcss_list_get, _Hamlib.rig_caps_ctcss_list_set
    )
    ...
    attenuator = property(
        _Hamlib.rig_caps_attenuator_get, _Hamlib.rig_caps_attenuator_set
    )
    ...
    max_ifshift = property(
        _Hamlib.rig_caps_max_ifshift_get, _Hamlib.rig_caps_max_ifshift_set
    )
    agc_level_count = property(
        _Hamlib.rig_caps_agc_level_count_get, _Hamlib.rig_caps_agc_level_count_set
    )
    agc_levels = property(
        _Hamlib.rig_caps_agc_levels_get, _Hamlib.rig_caps_agc_levels_set
    )
    ...
    targetable_vfo = property(
        _Hamlib.rig_caps_targetable_vfo_get, _Hamlib.rig_caps_targetable_vfo_set
    )
    transceive = property(
        _Hamlib.rig_caps_transceive_get, _Hamlib.rig_caps_transceive_set
    )
    bank_qty = property(_Hamlib.rig_caps_bank_qty_get, _Hamlib.rig_caps_bank_qty_set)
    chan_desc_sz = property(
        _Hamlib.rig_caps_chan_desc_sz_get, _Hamlib.rig_caps_chan_desc_sz_set
    )
    chan_list = property(_Hamlib.rig_caps_chan_list_get, _Hamlib.rig_caps_chan_list_set)
    rx_range_list1 = property(
        _Hamlib.rig_caps_rx_range_list1_get, _Hamlib.rig_caps_rx_range_list1_set
    )
    tx_range_list1 = property(
        _Hamlib.rig_caps_tx_range_list1_get, _Hamlib.rig_caps_tx_range_list1_set
    )
    rx_range_list2 = property(
        _Hamlib.rig_caps_rx_range_list2_get, _Hamlib.rig_caps_rx_range_list2_set
    )
    tx_range_list2 = property(
        _Hamlib.rig_caps_tx_range_list2_get, _Hamlib.rig_caps_tx_range_list2_set
    )
    rx_range_list3 = property(
        _Hamlib.rig_caps_rx_range_list3_get, _Hamlib.rig_caps_rx_range_list3_set
    )
    tx_range_list3 = property(
        _Hamlib.rig_caps_tx_range_list3_get, _Hamlib.rig_caps_tx_range_list3_set
    )
    rx_range_list4 = property(
        _Hamlib.rig_caps_rx_range_list4_get, _Hamlib.rig_caps_rx_range_list4_set
    )
    tx_range_list4 = property(
        _Hamlib.rig_caps_tx_range_list4_get, _Hamlib.rig_caps_tx_range_list4_set
    )
    rx_range_list5 = property(
        _Hamlib.rig_caps_rx_range_list5_get, _Hamlib.rig_caps_rx_range_list5_set
    )
    tx_range_list5 = property(
        _Hamlib.rig_caps_tx_range_list5_get, _Hamlib.rig_caps_tx_range_list5_set
    )
    tuning_steps = property(
        _Hamlib.rig_caps_tuning_steps_get, _Hamlib.rig_caps_tuning_steps_set
    )
    ...
    rfpower_meter_cal = property(
        _Hamlib.rig_caps_rfpower_meter_cal_get, _Hamlib.rig_caps_rfpower_meter_cal_set
    )
    comp_meter_cal = property(
        _Hamlib.rig_caps_comp_meter_cal_get, _Hamlib.rig_caps_comp_meter_cal_set
    )
    vd_meter_cal = property(
        _Hamlib.rig_caps_vd_meter_cal_get, _Hamlib.rig_caps_vd_meter_cal_set
    )
    id_meter_cal = property(
        _Hamlib.rig_caps_id_meter_cal_get, _Hamlib.rig_caps_id_meter_cal_set
    )
    spectrum_scopes = property(
        _Hamlib.rig_caps_spectrum_scopes_get, _Hamlib.rig_caps_spectrum_scopes_set
    )
    spectrum_modes = property(
        _Hamlib.rig_caps_spectrum_modes_get, _Hamlib.rig_caps_spectrum_modes_set
    )
    spectrum_spans = property(
        _Hamlib.rig_caps_spectrum_spans_get, _Hamlib.rig_caps_spectrum_spans_set
    )
    spectrum_avg_modes = property(
        _Hamlib.rig_caps_spectrum_avg_modes_get, _Hamlib.rig_caps_spectrum_avg_modes_set
    )
    spectrum_attenuator = property(
        _Hamlib.rig_caps_spectrum_attenuator_get,
        _Hamlib.rig_caps_spectrum_attenuator_set,
    )
    ...
    set_rptr_shift = property(
        _Hamlib.rig_caps_set_rptr_shift_get, _Hamlib.rig_caps_set_rptr_shift_set
    )
    get_rptr_shift = property(
        _Hamlib.rig_caps_get_rptr_shift_get, _Hamlib.rig_caps_get_rptr_shift_set
    )
    set_rptr_offs = property(
        _Hamlib.rig_caps_set_rptr_offs_get, _Hamlib.rig_caps_set_rptr_offs_set
    )
    get_rptr_offs = property(
        _Hamlib.rig_caps_get_rptr_offs_get, _Hamlib.rig_caps_get_rptr_offs_set
    )
    set_split_freq = property(
        _Hamlib.rig_caps_set_split_freq_get, _Hamlib.rig_caps_set_split_freq_set
    )
    get_split_freq = property(
        _Hamlib.rig_caps_get_split_freq_get, _Hamlib.rig_caps_get_split_freq_set
    )
    set_split_mode = property(
        _Hamlib.rig_caps_set_split_mode_get, _Hamlib.rig_caps_set_split_mode_set
    )
    get_split_mode = property(
        _Hamlib.rig_caps_get_split_mode_get, _Hamlib.rig_caps_get_split_mode_set
    )
    set_split_freq_mode = property(
        _Hamlib.rig_caps_set_split_freq_mode_get,
        _Hamlib.rig_caps_set_split_freq_mode_set,
    )
    get_split_freq_mode = property(
        _Hamlib.rig_caps_get_split_freq_mode_get,
        _Hamlib.rig_caps_get_split_freq_mode_set,
    )
    set_split_vfo = property(
        _Hamlib.rig_caps_set_split_vfo_get, _Hamlib.rig_caps_set_split_vfo_set
    )
    get_split_vfo = property(
        _Hamlib.rig_caps_get_split_vfo_get, _Hamlib.rig_caps_get_split_vfo_set
    )
    ...
    set_dcs_code = property(
        _Hamlib.rig_caps_set_dcs_code_get, _Hamlib.rig_caps_set_dcs_code_set
    )
    get_dcs_code = property(
        _Hamlib.rig_caps_get_dcs_code_get, _Hamlib.rig_caps_get_dcs_code_set
    )
    ...
    set_ctcss_tone = property(
        _Hamlib.rig_caps_set_ctcss_tone_get, _Hamlib.rig_caps_set_ctcss_tone_set
    )
    get_ctcss_tone = property(
        _Hamlib.rig_caps_get_ctcss_tone_get, _Hamlib.rig_caps_get_ctcss_tone_set
    )
    set_dcs_sql = property(
        _Hamlib.rig_caps_set_dcs_sql_get, _Hamlib.rig_caps_set_dcs_sql_set
    )
    get_dcs_sql = property(
        _Hamlib.rig_caps_get_dcs_sql_get, _Hamlib.rig_caps_get_dcs_sql_set
    )
    set_tone_sql = property(
        _Hamlib.rig_caps_set_tone_sql_get, _Hamlib.rig_caps_set_tone_sql_set
    )
    get_tone_sql = property(
        _Hamlib.rig_caps_get_tone_sql_get, _Hamlib.rig_caps_get_tone_sql_set
    )
    set_ctcss_sql = property(
        _Hamlib.rig_caps_set_ctcss_sql_get, _Hamlib.rig_caps_set_ctcss_sql_set
    )
    get_ctcss_sql = property(
        _Hamlib.rig_caps_get_ctcss_sql_get, _Hamlib.rig_caps_get_ctcss_sql_set
    )
    ...
    set_powerstat = property(
        _Hamlib.rig_caps_set_powerstat_get, _Hamlib.rig_caps_set_powerstat_set
    )
    get_powerstat = property(
        _Hamlib.rig_caps_get_powerstat_get, _Hamlib.rig_caps_get_powerstat_set
    )
    ...
    set_ext_level = property(
        _Hamlib.rig_caps_set_ext_level_get, _Hamlib.rig_caps_set_ext_level_set
    )
    get_ext_level = property(
        _Hamlib.rig_caps_get_ext_level_get, _Hamlib.rig_caps_get_ext_level_set
    )
    set_ext_func = property(
        _Hamlib.rig_caps_set_ext_func_get, _Hamlib.rig_caps_set_ext_func_set
    )
    get_ext_func = property(
        _Hamlib.rig_caps_get_ext_func_get, _Hamlib.rig_caps_get_ext_func_set
    )
    set_ext_parm = property(
        _Hamlib.rig_caps_set_ext_parm_get, _Hamlib.rig_caps_set_ext_parm_set
    )
    get_ext_parm = property(
        _Hamlib.rig_caps_get_ext_parm_get, _Hamlib.rig_caps_get_ext_parm_set
    )
    ...
    send_morse = property(
        _Hamlib.rig_caps_send_morse_get, _Hamlib.rig_caps_send_morse_set
    )
    stop_morse = property(
        _Hamlib.rig_caps_stop_morse_get, _Hamlib.rig_caps_stop_morse_set
    )
    wait_morse = property(
        _Hamlib.rig_caps_wait_morse_get, _Hamlib.rig_caps_wait_morse_set
    )
    send_voice_mem = property(
        _Hamlib.rig_caps_send_voice_mem_get, _Hamlib.rig_caps_send_voice_mem_set
    )
    ...
    decode_event = property(
        _Hamlib.rig_caps_decode_event_get, _Hamlib.rig_caps_decode_event_set
    )
    set_channel = property(
        _Hamlib.rig_caps_set_channel_get, _Hamlib.rig_caps_set_channel_set
    )
    get_channel = property(
        _Hamlib.rig_caps_get_channel_get, _Hamlib.rig_caps_get_channel_set
    )
    get_info = property(_Hamlib.rig_caps_get_info_get, _Hamlib.rig_caps_get_info_set)
    set_chan_all_cb = property(
        _Hamlib.rig_caps_set_chan_all_cb_get, _Hamlib.rig_caps_set_chan_all_cb_set
    )
    get_chan_all_cb = property(
        _Hamlib.rig_caps_get_chan_all_cb_get, _Hamlib.rig_caps_get_chan_all_cb_set
    )
    set_mem_all_cb = property(
        _Hamlib.rig_caps_set_mem_all_cb_get, _Hamlib.rig_caps_set_mem_all_cb_set
    )
    get_mem_all_cb = property(
        _Hamlib.rig_caps_get_mem_all_cb_get, _Hamlib.rig_caps_get_mem_all_cb_set
    )
    set_vfo_opt = property(
        _Hamlib.rig_caps_set_vfo_opt_get, _Hamlib.rig_caps_set_vfo_opt_set
    )
...
class hamlib_port_t(object):
    ...
    handle = property(
        _Hamlib.hamlib_port_t_handle_get, _Hamlib.hamlib_port_t_handle_set
    )
    write_delay = property(
        _Hamlib.hamlib_port_t_write_delay_get, _Hamlib.hamlib_port_t_write_delay_set
    )
    post_write_delay = property(
        _Hamlib.hamlib_port_t_post_write_delay_get,
        _Hamlib.hamlib_port_t_post_write_delay_set,
    )
    post_write_date = property(_Hamlib.hamlib_port_t_post_write_date_get)
    timeout = property(
        _Hamlib.hamlib_port_t_timeout_get, _Hamlib.hamlib_port_t_timeout_set
    )
    retry = property(_Hamlib.hamlib_port_t_retry_get, _Hamlib.hamlib_port_t_retry_set)
    flushx = property(
        _Hamlib.hamlib_port_t_flushx_get, _Hamlib.hamlib_port_t_flushx_set
    )
    pathname = property(
        _Hamlib.hamlib_port_t_pathname_get, _Hamlib.hamlib_port_t_pathname_set
    )
    parm = property(_Hamlib.hamlib_port_t_parm_get)
    client_port = property(
        _Hamlib.hamlib_port_t_client_port_get, _Hamlib.hamlib_port_t_client_port_set
    )
...
class hamlib_port_parm_gpio(object):
    ...
    __repr__ = _swig_repr
    on_value = property(
        _Hamlib.hamlib_port_parm_gpio_on_value_get,
        _Hamlib.hamlib_port_parm_gpio_on_value_set,
    )
    value = property(
        _Hamlib.hamlib_port_parm_gpio_value_get, _Hamlib.hamlib_port_parm_gpio_value_set
    )

    def __init__(self):
        _Hamlib.hamlib_port_parm_gpio_swiginit(
            self, _Hamlib.new_hamlib_port_parm_gpio()
        )
...
class hamlib_port_parm_usb(object):
    ...
    __repr__ = _swig_repr
    vid = property(
        _Hamlib.hamlib_port_parm_usb_vid_get, _Hamlib.hamlib_port_parm_usb_vid_set
    )
    pid = property(
        _Hamlib.hamlib_port_parm_usb_pid_get, _Hamlib.hamlib_port_parm_usb_pid_set
    )
    conf = property(
        _Hamlib.hamlib_port_parm_usb_conf_get, _Hamlib.hamlib_port_parm_usb_conf_set
    )
    iface = property(
        _Hamlib.hamlib_port_parm_usb_iface_get, _Hamlib.hamlib_port_parm_usb_iface_set
    )
    alt = property(
        _Hamlib.hamlib_port_parm_usb_alt_get, _Hamlib.hamlib_port_parm_usb_alt_set
    )
    vendor_name = property(
        _Hamlib.hamlib_port_parm_usb_vendor_name_get,
        _Hamlib.hamlib_port_parm_usb_vendor_name_set,
    )
    product = property(
        _Hamlib.hamlib_port_parm_usb_product_get,
        _Hamlib.hamlib_port_parm_usb_product_set,
    )
...
class hamlib_port_parm_cm108(object):
    ...
    __repr__ = _swig_repr
    ptt_bitnum = property(
        _Hamlib.hamlib_port_parm_cm108_ptt_bitnum_get,
        _Hamlib.hamlib_port_parm_cm108_ptt_bitnum_set,
    )

    def __init__(self):
        _Hamlib.hamlib_port_parm_cm108_swiginit(
            self, _Hamlib.new_hamlib_port_parm_cm108()
        )
...
class hamlib_port_parm_parallel(object):
    ...
    __repr__ = _swig_repr
    pin = property(
        _Hamlib.hamlib_port_parm_parallel_pin_get,
        _Hamlib.hamlib_port_parm_parallel_pin_set,
    )
...
class hamlib_port_parm_serial(object):
    ...
    __repr__ = _swig_repr
    rate = property(
        _Hamlib.hamlib_port_parm_serial_rate_get,
        _Hamlib.hamlib_port_parm_serial_rate_set,
    )
    data_bits = property(
        _Hamlib.hamlib_port_parm_serial_data_bits_get,
        _Hamlib.hamlib_port_parm_serial_data_bits_set,
    )
    stop_bits = property(
        _Hamlib.hamlib_port_parm_serial_stop_bits_get,
        _Hamlib.hamlib_port_parm_serial_stop_bits_set,
    )
    parity = property(
        _Hamlib.hamlib_port_parm_serial_parity_get,
        _Hamlib.hamlib_port_parm_serial_parity_set,
    )
    handshake = property(
        _Hamlib.hamlib_port_parm_serial_handshake_get,
        _Hamlib.hamlib_port_parm_serial_handshake_set,
    )
    rts_state = property(
        _Hamlib.hamlib_port_parm_serial_rts_state_get,
        _Hamlib.hamlib_port_parm_serial_rts_state_set,
    )
    dtr_state = property(
        _Hamlib.hamlib_port_parm_serial_dtr_state_get,
        _Hamlib.hamlib_port_parm_serial_dtr_state_set,
    )
...
class hamlib_port_post_write_date(object):
    ...
    __repr__ = _swig_repr
    tv_sec = property(
        _Hamlib.hamlib_port_post_write_date_tv_sec_get,
        _Hamlib.hamlib_port_post_write_date_tv_sec_set,
    )
    tv_usec = property(
        _Hamlib.hamlib_port_post_write_date_tv_usec_get,
        _Hamlib.hamlib_port_post_write_date_tv_usec_set,
    )

    def __init__(self):
        _Hamlib.hamlib_port_post_write_date_swiginit(
            self, _Hamlib.new_hamlib_port_post_write_date()
        )
...
class rig_cache(object):
    ...
    __repr__ = _swig_repr
    timeout_ms = property(
        _Hamlib.rig_cache_timeout_ms_get, _Hamlib.rig_cache_timeout_ms_set
    )
    ...
    freqOther = property(
        _Hamlib.rig_cache_freqOther_get, _Hamlib.rig_cache_freqOther_set
    )
    freqMainA = property(
        _Hamlib.rig_cache_freqMainA_get, _Hamlib.rig_cache_freqMainA_set
    )
    freqMainB = property(
        _Hamlib.rig_cache_freqMainB_get, _Hamlib.rig_cache_freqMainB_set
    )
    freqMainC = property(
        _Hamlib.rig_cache_freqMainC_get, _Hamlib.rig_cache_freqMainC_set
    )
    ...
    modeOther = property(
        _Hamlib.rig_cache_modeOther_get, _Hamlib.rig_cache_modeOther_set
    )
    modeMainA = property(
        _Hamlib.rig_cache_modeMainA_get, _Hamlib.rig_cache_modeMainA_set
    )
    modeMainB = property(
        _Hamlib.rig_cache_modeMainB_get, _Hamlib.rig_cache_modeMainB_set
    )
    modeMainC = property(
        _Hamlib.rig_cache_modeMainC_get, _Hamlib.rig_cache_modeMainC_set
    )
    ...
    widthCurr = property(
        _Hamlib.rig_cache_widthCurr_get, _Hamlib.rig_cache_widthCurr_set
    )
    widthOther = property(
        _Hamlib.rig_cache_widthOther_get, _Hamlib.rig_cache_widthOther_set
    )
    widthMainA = property(
        _Hamlib.rig_cache_widthMainA_get, _Hamlib.rig_cache_widthMainA_set
    )
    widthMainB = property(
        _Hamlib.rig_cache_widthMainB_get, _Hamlib.rig_cache_widthMainB_set
    )
    widthMainC = property(
        _Hamlib.rig_cache_widthMainC_get, _Hamlib.rig_cache_widthMainC_set
    )
    widthSubA = property(
        _Hamlib.rig_cache_widthSubA_get, _Hamlib.rig_cache_widthSubA_set
    )
    widthSubB = property(
        _Hamlib.rig_cache_widthSubB_get, _Hamlib.rig_cache_widthSubB_set
    )
    widthSubC = property(
        _Hamlib.rig_cache_widthSubC_get, _Hamlib.rig_cache_widthSubC_set
    )
    ...
    split_vfo = property(
        _Hamlib.rig_cache_split_vfo_get, _Hamlib.rig_cache_split_vfo_set
    )
    time_freqCurr = property(
        _Hamlib.rig_cache_time_freqCurr_get, _Hamlib.rig_cache_time_freqCurr_set
    )
    time_freqOther = property(
        _Hamlib.rig_cache_time_freqOther_get, _Hamlib.rig_cache_time_freqOther_set
    )
    time_freqMainA = property(
        _Hamlib.rig_cache_time_freqMainA_get, _Hamlib.rig_cache_time_freqMainA_set
    )
    time_freqMainB = property(
        _Hamlib.rig_cache_time_freqMainB_get, _Hamlib.rig_cache_time_freqMainB_set
    )
    time_freqMainC = property(
        _Hamlib.rig_cache_time_freqMainC_get, _Hamlib.rig_cache_time_freqMainC_set
    )
    time_freqSubA = property(
        _Hamlib.rig_cache_time_freqSubA_get, _Hamlib.rig_cache_time_freqSubA_set
    )
    time_freqSubB = property(
        _Hamlib.rig_cache_time_freqSubB_get, _Hamlib.rig_cache_time_freqSubB_set
    )
    time_freqSubC = property(
        _Hamlib.rig_cache_time_freqSubC_get, _Hamlib.rig_cache_time_freqSubC_set
    )
    time_freqMem = property(
        _Hamlib.rig_cache_time_freqMem_get, _Hamlib.rig_cache_time_freqMem_set
    )
    time_vfo = property(_Hamlib.rig_cache_time_vfo_get, _Hamlib.rig_cache_time_vfo_set)
    time_modeCurr = property(
        _Hamlib.rig_cache_time_modeCurr_get, _Hamlib.rig_cache_time_modeCurr_set
    )
    time_modeOther = property(
        _Hamlib.rig_cache_time_modeOther_get, _Hamlib.rig_cache_time_modeOther_set
    )
    time_modeMainA = property(
        _Hamlib.rig_cache_time_modeMainA_get, _Hamlib.rig_cache_time_modeMainA_set
    )
    time_modeMainB = property(
        _Hamlib.rig_cache_time_modeMainB_get, _Hamlib.rig_cache_time_modeMainB_set
    )
    time_modeMainC = property(
        _Hamlib.rig_cache_time_modeMainC_get, _Hamlib.rig_cache_time_modeMainC_set
    )
    time_modeSubA = property(
        _Hamlib.rig_cache_time_modeSubA_get, _Hamlib.rig_cache_time_modeSubA_set
    )
    time_modeSubB = property(
        _Hamlib.rig_cache_time_modeSubB_get, _Hamlib.rig_cache_time_modeSubB_set
    )
    time_modeSubC = property(
        _Hamlib.rig_cache_time_modeSubC_get, _Hamlib.rig_cache_time_modeSubC_set
    )
    time_modeMem = property(
        _Hamlib.rig_cache_time_modeMem_get, _Hamlib.rig_cache_time_modeMem_set
    )
    time_widthCurr = property(
        _Hamlib.rig_cache_time_widthCurr_get, _Hamlib.rig_cache_time_widthCurr_set
    )
    time_widthOther = property(
        _Hamlib.rig_cache_time_widthOther_get, _Hamlib.rig_cache_time_widthOther_set
    )
    time_widthMainA = property(
        _Hamlib.rig_cache_time_widthMainA_get, _Hamlib.rig_cache_time_widthMainA_set
    )
    time_widthMainB = property(
        _Hamlib.rig_cache_time_widthMainB_get, _Hamlib.rig_cache_time_widthMainB_set
    )
    time_widthMainC = property(
        _Hamlib.rig_cache_time_widthMainC_get, _Hamlib.rig_cache_time_widthMainC_set
    )
    time_widthSubA = property(
        _Hamlib.rig_cache_time_widthSubA_get, _Hamlib.rig_cache_time_widthSubA_set
    )
    time_widthSubB = property(
        _Hamlib.rig_cache_time_widthSubB_get, _Hamlib.rig_cache_time_widthSubB_set
    )
    time_widthSubC = property(
        _Hamlib.rig_cache_time_widthSubC_get, _Hamlib.rig_cache_time_widthSubC_set
    )
    time_widthMem = property(
        _Hamlib.rig_cache_time_widthMem_get, _Hamlib.rig_cache_time_widthMem_set
    )
    time_ptt = property(_Hamlib.rig_cache_time_ptt_get, _Hamlib.rig_cache_time_ptt_set)
    time_split = property(
        _Hamlib.rig_cache_time_split_get, _Hamlib.rig_cache_time_split_set
    )
...
class rig_state(object):
    ...
    deprecated_itu_region = property(
        _Hamlib.rig_state_deprecated_itu_region_get,
        _Hamlib.rig_state_deprecated_itu_region_set,
    )
    rx_range_list = property(
        _Hamlib.rig_state_rx_range_list_get, _Hamlib.rig_state_rx_range_list_set
    )
    tx_range_list = property(
        _Hamlib.rig_state_tx_range_list_get, _Hamlib.rig_state_tx_range_list_set
    )
    tuning_steps = property(
        _Hamlib.rig_state_tuning_steps_get, _Hamlib.rig_state_tuning_steps_set
    )
    ...
    chan_list = property(
        _Hamlib.rig_state_chan_list_get, _Hamlib.rig_state_chan_list_set
    )
    ...
    max_ifshift = property(
        _Hamlib.rig_state_max_ifshift_get, _Hamlib.rig_state_max_ifshift_set
    )
    announces = property(
        _Hamlib.rig_state_announces_get, _Hamlib.rig_state_announces_set
    )
    preamp = property(_Hamlib.rig_state_preamp_get, _Hamlib.rig_state_preamp_set)
    attenuator = property(
        _Hamlib.rig_state_attenuator_get, _Hamlib.rig_state_attenuator_set
    )
    has_get_func = property(
        _Hamlib.rig_state_has_get_func_get, _Hamlib.rig_state_has_get_func_set
    )
    has_set_func = property(
        _Hamlib.rig_state_has_set_func_get, _Hamlib.rig_state_has_set_func_set
    )
    has_get_level = property(
        _Hamlib.rig_state_has_get_level_get, _Hamlib.rig_state_has_get_level_set
    )
    has_set_level = property(
        _Hamlib.rig_state_has_set_level_get, _Hamlib.rig_state_has_set_level_set
    )
    has_get_parm = property(
        _Hamlib.rig_state_has_get_parm_get, _Hamlib.rig_state_has_get_parm_set
    )
    has_set_parm = property(
        _Hamlib.rig_state_has_set_parm_get, _Hamlib.rig_state_has_set_parm_set
    )
    level_gran = property(
        _Hamlib.rig_state_level_gran_get, _Hamlib.rig_state_level_gran_set
    )
    parm_gran = property(
        _Hamlib.rig_state_parm_gran_get, _Hamlib.rig_state_parm_gran_set
    )
    hold_decode = property(
        _Hamlib.rig_state_hold_decode_get, _Hamlib.rig_state_hold_decode_set
    )
    current_vfo = property(
        _Hamlib.rig_state_current_vfo_get, _Hamlib.rig_state_current_vfo_set
    )
    vfo_list = property(_Hamlib.rig_state_vfo_list_get, _Hamlib.rig_state_vfo_list_set)
    comm_state = property(
        _Hamlib.rig_state_comm_state_get, _Hamlib.rig_state_comm_state_set
    )
    ...
    transceive = property(
        _Hamlib.rig_state_transceive_get, _Hamlib.rig_state_transceive_set
    )
    poll_interval = property(
        _Hamlib.rig_state_poll_interval_get, _Hamlib.rig_state_poll_interval_set
    )
    current_freq = property(
        _Hamlib.rig_state_current_freq_get, _Hamlib.rig_state_current_freq_set
    )
    current_mode = property(
        _Hamlib.rig_state_current_mode_get, _Hamlib.rig_state_current_mode_set
    )
    current_width = property(
        _Hamlib.rig_state_current_width_get, _Hamlib.rig_state_current_width_set
    )
    tx_vfo = property(_Hamlib.rig_state_tx_vfo_get, _Hamlib.rig_state_tx_vfo_set)
    mode_list = property(
        _Hamlib.rig_state_mode_list_get, _Hamlib.rig_state_mode_list_set
    )
    ...
    twiddle_time = property(
        _Hamlib.rig_state_twiddle_time_get, _Hamlib.rig_state_twiddle_time_set
    )
    twiddle_timeout = property(
        _Hamlib.rig_state_twiddle_timeout_get, _Hamlib.rig_state_twiddle_timeout_set
    )
    ...
    auto_power_on = property(
        _Hamlib.rig_state_auto_power_on_get, _Hamlib.rig_state_auto_power_on_set
    )
    auto_power_off = property(
        _Hamlib.rig_state_auto_power_off_get, _Hamlib.rig_state_auto_power_off_set
    )
    auto_disable_screensaver = property(
        _Hamlib.rig_state_auto_disable_screensaver_get,
        _Hamlib.rig_state_auto_disable_screensaver_set,
    )
    ptt_share = property(
        _Hamlib.rig_state_ptt_share_get, _Hamlib.rig_state_ptt_share_set
    )
    power_now = property(
        _Hamlib.rig_state_power_now_get, _Hamlib.rig_state_power_now_set
    )
    power_min = property(
        _Hamlib.rig_state_power_min_get, _Hamlib.rig_state_power_min_set
    )
    power_max = property(
        _Hamlib.rig_state_power_max_get, _Hamlib.rig_state_power_max_set
    )
    disable_yaesu_bandselect = property(
        _Hamlib.rig_state_disable_yaesu_bandselect_get,
        _Hamlib.rig_state_disable_yaesu_bandselect_set,
    )
    twiddle_rit = property(
        _Hamlib.rig_state_twiddle_rit_get, _Hamlib.rig_state_twiddle_rit_set
    )
    twiddle_state = property(
        _Hamlib.rig_state_twiddle_state_get, _Hamlib.rig_state_twiddle_state_set
    )
...
class rig_callbacks(object):
    ...
    __repr__ = _swig_repr
    freq_event = property(
        _Hamlib.rig_callbacks_freq_event_get, _Hamlib.rig_callbacks_freq_event_set
    )
    freq_arg = property(
        _Hamlib.rig_callbacks_freq_arg_get, _Hamlib.rig_callbacks_freq_arg_set
    )
    mode_event = property(
        _Hamlib.rig_callbacks_mode_event_get, _Hamlib.rig_callbacks_mode_event_set
    )
    mode_arg = property(
        _Hamlib.rig_callbacks_mode_arg_get, _Hamlib.rig_callbacks_mode_arg_set
    )
    vfo_event = property(
        _Hamlib.rig_callbacks_vfo_event_get, _Hamlib.rig_callbacks_vfo_event_set
    )
    vfo_arg = property(
        _Hamlib.rig_callbacks_vfo_arg_get, _Hamlib.rig_callbacks_vfo_arg_set
    )
    ptt_event = property(
        _Hamlib.rig_callbacks_ptt_event_get, _Hamlib.rig_callbacks_ptt_event_set
    )
    ptt_arg = property(
        _Hamlib.rig_callbacks_ptt_arg_get, _Hamlib.rig_callbacks_ptt_arg_set
    )
    dcd_event = property(
        _Hamlib.rig_callbacks_dcd_event_get, _Hamlib.rig_callbacks_dcd_event_set
    )
    dcd_arg = property(
        _Hamlib.rig_callbacks_dcd_arg_get, _Hamlib.rig_callbacks_dcd_arg_set
    )
    pltune = property(
        _Hamlib.rig_callbacks_pltune_get, _Hamlib.rig_callbacks_pltune_set
    )
    pltune_arg = property(
        _Hamlib.rig_callbacks_pltune_arg_get, _Hamlib.rig_callbacks_pltune_arg_set
    )
    spectrum_event = property(
        _Hamlib.rig_callbacks_spectrum_event_get,
        _Hamlib.rig_callbacks_spectrum_event_set,
    )
    spectrum_arg = property(
        _Hamlib.rig_callbacks_spectrum_arg_get, _Hamlib.rig_callbacks_spectrum_arg_set
    )
...
def rig_get_cache(
    rig, vfo, freq, cache_ms_freq, mode, cache_ms_mode, width, cache_ms_width
):
    return _Hamlib.rig_get_cache(
        rig, vfo, freq, cache_ms_freq, mode, cache_ms_mode, width, cache_ms_width
    )


def rig_set_clock(rig, year, month, day, hour, min, sec, msec, utc_offset):
    return _Hamlib.rig_set_clock(
        rig, year, month, day, hour, min, sec, msec, utc_offset
    )


def rig_get_clock(rig, year, month, day, hour, min, sec, msec, utc_offset):
    return _Hamlib.rig_get_clock(
        rig, year, month, day, hour, min, sec, msec, utc_offset
    )
...
class rot_caps(object):
    ...
    serial_rate_min = property(
        _Hamlib.rot_caps_serial_rate_min_get, _Hamlib.rot_caps_serial_rate_min_set
    )
    serial_rate_max = property(
        _Hamlib.rot_caps_serial_rate_max_get, _Hamlib.rot_caps_serial_rate_max_set
    )
    serial_data_bits = property(
        _Hamlib.rot_caps_serial_data_bits_get, _Hamlib.rot_caps_serial_data_bits_set
    )
    serial_stop_bits = property(
        _Hamlib.rot_caps_serial_stop_bits_get, _Hamlib.rot_caps_serial_stop_bits_set
    )
    serial_parity = property(
        _Hamlib.rot_caps_serial_parity_get, _Hamlib.rot_caps_serial_parity_set
    )
    serial_handshake = property(
        _Hamlib.rot_caps_serial_handshake_get, _Hamlib.rot_caps_serial_handshake_set
    )
    write_delay = property(
        _Hamlib.rot_caps_write_delay_get, _Hamlib.rot_caps_write_delay_set
    )
    post_write_delay = property(
        _Hamlib.rot_caps_post_write_delay_get, _Hamlib.rot_caps_post_write_delay_set
    )
    ...
    has_get_func = property(
        _Hamlib.rot_caps_has_get_func_get, _Hamlib.rot_caps_has_get_func_set
    )
    has_set_func = property(
        _Hamlib.rot_caps_has_set_func_get, _Hamlib.rot_caps_has_set_func_set
    )
    has_get_level = property(
        _Hamlib.rot_caps_has_get_level_get, _Hamlib.rot_caps_has_get_level_set
    )
    has_set_level = property(
        _Hamlib.rot_caps_has_set_level_get, _Hamlib.rot_caps_has_set_level_set
    )
    has_get_parm = property(
        _Hamlib.rot_caps_has_get_parm_get, _Hamlib.rot_caps_has_get_parm_set
    )
    has_set_parm = property(
        _Hamlib.rot_caps_has_set_parm_get, _Hamlib.rot_caps_has_set_parm_set
    )
    has_status = property(
        _Hamlib.rot_caps_has_status_get, _Hamlib.rot_caps_has_status_set
    )
    level_gran = property(
        _Hamlib.rot_caps_level_gran_get, _Hamlib.rot_caps_level_gran_set
    )
    ...
    ext_tokens = property(
        _Hamlib.rot_caps_ext_tokens_get, _Hamlib.rot_caps_ext_tokens_set
    )
    ...
    set_position = property(
        _Hamlib.rot_caps_set_position_get, _Hamlib.rot_caps_set_position_set
    )
    get_position = property(
        _Hamlib.rot_caps_get_position_get, _Hamlib.rot_caps_get_position_set
    )
    ...
    set_ext_level = property(
        _Hamlib.rot_caps_set_ext_level_get, _Hamlib.rot_caps_set_ext_level_set
    )
    get_ext_level = property(
        _Hamlib.rot_caps_get_ext_level_get, _Hamlib.rot_caps_get_ext_level_set
    )
    set_ext_func = property(
        _Hamlib.rot_caps_set_ext_func_get, _Hamlib.rot_caps_set_ext_func_set
    )
    get_ext_func = property(
        _Hamlib.rot_caps_get_ext_func_get, _Hamlib.rot_caps_get_ext_func_set
    )
    set_ext_parm = property(
        _Hamlib.rot_caps_set_ext_parm_get, _Hamlib.rot_caps_set_ext_parm_set
    )
    get_ext_parm = property(
        _Hamlib.rot_caps_get_ext_parm_get, _Hamlib.rot_caps_get_ext_parm_set
    )
    get_status = property(
        _Hamlib.rot_caps_get_status_get, _Hamlib.rot_caps_get_status_set
    )
...
class rot_state(object):
    ...
    south_zero = property(
        _Hamlib.rot_state_south_zero_get, _Hamlib.rot_state_south_zero_set
    )
    az_offset = property(
        _Hamlib.rot_state_az_offset_get, _Hamlib.rot_state_az_offset_set
    )
    el_offset = property(
        _Hamlib.rot_state_el_offset_get, _Hamlib.rot_state_el_offset_set
    )
    has_get_func = property(
        _Hamlib.rot_state_has_get_func_get, _Hamlib.rot_state_has_get_func_set
    )
    has_set_func = property(
        _Hamlib.rot_state_has_set_func_get, _Hamlib.rot_state_has_set_func_set
    )
    has_get_level = property(
        _Hamlib.rot_state_has_get_level_get, _Hamlib.rot_state_has_get_level_set
    )
    has_set_level = property(
        _Hamlib.rot_state_has_set_level_get, _Hamlib.rot_state_has_set_level_set
    )
    has_get_parm = property(
        _Hamlib.rot_state_has_get_parm_get, _Hamlib.rot_state_has_get_parm_set
    )
    has_set_parm = property(
        _Hamlib.rot_state_has_set_parm_get, _Hamlib.rot_state_has_set_parm_set
    )
    has_status = property(
        _Hamlib.rot_state_has_status_get, _Hamlib.rot_state_has_status_set
    )
    level_gran = property(
        _Hamlib.rot_state_level_gran_get, _Hamlib.rot_state_level_gran_set
    )
    parm_gran = property(
        _Hamlib.rot_state_parm_gran_get, _Hamlib.rot_state_parm_gran_set
    )
    ...
    comm_state = property(
        _Hamlib.rot_state_comm_state_get, _Hamlib.rot_state_comm_state_set
    )
    ...
    current_speed = property(
        _Hamlib.rot_state_current_speed_get, _Hamlib.rot_state_current_speed_set
    )
